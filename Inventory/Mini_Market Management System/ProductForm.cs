    ...
    public partial class ProductForm : Form
    {
        ...
        private void button_add_Click(object sender, EventArgs e)
        {
            if(productName.Text != "" && productPrice.Text != "")
            {
                try
                {
                    string insertQuery = "INSERT INTO product(name, price, quantity, category) VALUES('" + productName.Text + "', '" + productPrice.Text + "', '" + productQuantity.Text + "', '" + productCategory.Text + "')";
