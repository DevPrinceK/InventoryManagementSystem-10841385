...
namespace Moses_Market_Management_System
{
    public partial class LoginForm : Form
    {
        ...
        private void Button_login_Click(object sender, EventArgs e)
        {
            ...
            if (username.Text != "" && password.Text != "" && (role.Text == "Admin" || role.Text == "Attendant") )
            {
                try
                {
                    // checker
                    bool UserIsFound = false;
                    string insertQuery = "select * from user where username='" + username.Text + "'&& password='" + password.Text + "'&& role='" + role.Text  + "'" ;
